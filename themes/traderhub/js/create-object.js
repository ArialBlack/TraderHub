...
var _createClass = function () {
  ...
  var a = function () {
    ...
    return _createClass(a, [{
      ...
      key: "getLandingData", value: function getLandingData() {
        var b = {formId: this.config.landingId, formFieldsData: []};
        return this.setFieldsData(b), a.setCookiesData(b), b
      }
    }, {
      key: "onError", value: function onError(b, c, d) {
        a.jQuery.isFunction(this.config.onError) && this.config.onError(b, c, d)
      }
    }, {
      key: "onComplete", value: function onComplete(b) {
        a.jQuery.isFunction(this.config.onComplete) && this.config.onComplete(b)
      }
    }, {
      key: "onSuccess", value: function onSuccess(b) {
        a.jQuery.isFunction(this.config.onSuccess) && this.config.onSuccess(b)
      }
    }, {
      key: "onResponse", value: function onResponse(b) {
      ...
      key: "contactId", get: function get() {
        if (!this._contactId) {
      ...
      key: "bulkEmailRecipientId", get: function get() {
      ...
      key: "addFieldRecord", value: function addFieldRecord(b, c, d) {
        b.formFieldsData.push({name: c, value: d})
      }
    }, {
      key: "parseResponse", value: function parseResponse(b) {
        return b = b.replace("resultCode", "\"resultCode\""), b = b.replace("resultMessage", "\"resultMessage\""), JSON.parse(b)
      }
    }, {
      key: "getCookie", value: function getCookie(b) {
        if (!b) {
          return "";
        }
      ...
      key: "getCorrectCookiesName", value: function getCorrectCookiesName(b) {
        return {
          BpmRef: "bpmRef",
          BpmHref: "bpmHref",
      ...
      key: "setCookiesData", value: function setCookiesData(b) {
        var _arr = ["BpmRef", "BpmHref", "BpmSessionId"];
        for (var _i = 0; _i < _arr.length; _i++) {
          var c = _arr[_i], d = a.getCorrectCookiesName(c), e = a.getCookie(d);
      ...
      key: "getURLParameter", value: function getURLParameter(b) {
        return decodeURIComponent((RegExp("[?|&]" + b + "=(.+?)(&|$)", "i").exec(a.getLocationSearch()) || [, ""])[1])
      }
    }, {
      key: "getLocationSearch", value: function getLocationSearch() {
      ...
      key: "contactIdKey", get: function get() {
        return "ContactId"
      }
    }, {
      key: "bulkEmailRecipientIdKey", get: function get() {
        return "BulkEmailRecipientId"
      }
    }, {
      key: "cookieExpireDays", get: function get() {
        return 7
      }
    }, {
      key: "cookie", get: function get() {
        return document.cookie
      }
    }, {
      key: "jQuery", get: function get() {
        if (!window.jQuery) {
          throw Error("jQuery not found");
        }
