...
To use these stylesheets, rename the files and traderhub with the name of your theme.
...
traderhub-alpha-default-narrow.css  
...
traderhub-alpha-default-normal.css
...
traderhub-alpha-default-wide.css
